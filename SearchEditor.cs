...
{
    protected static string _SearchResult = string.Empty;

    // Seach cancel button 
    protected const float _SEACH_CANCEL_WIDTH = 22, _SEACH_CANCEL_BUTTON_HEIGHT = 22;
    ...
    public static string DrawSearch(Vector2 position)
    {
        ...
        // Darw text field
        _SearchResult = GUI.TextField(new Rect(_Rect.x + 3, _Rect.y + _YCenter, _Rect.width, _Rect.height), _SearchResult, EditorStyles.toolbarSearchField);
